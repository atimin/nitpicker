...
class TestCfgFile(unittest.TestCase):
    ...
    def test_load_settings_from_cfg_file(self):
        __main_imp__(self.__ctx, qa_dir=None, no_editor=None, report_dir=None, vcs=None, debug=None, main_branch=None,
    ...
    def test_command_option_override_cfg_file(self):
        __main_imp__(self.__ctx, qa_dir='option_dir', no_editor=False, report_dir='option_report', vcs='option_vcs',
        ...
        self.assertEqual(self.__ctx.obj['vcs'], 'option_vcs')
    ...
    def test_using_default_settings_if_config_not_exists(self):
        __main_imp__(self.__ctx, qa_dir=None, no_editor=None, report_dir=None, vcs=None,
